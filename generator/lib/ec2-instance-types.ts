import { EC2, type InstanceTypeInfo, paginateDescribeInstanceTypes } from '@aws-sdk/client-ec2';
...
export async function getInstanceTypes() {
  ...
  for (let instanceType of Object.values(instanceTypes)) {
    ...
    if (instanceFamilies[family] == undefined) {
      instanceFamilies[family] = {
        name: family,
        regions: regionsByInstanceType[instanceType.InstanceType!],
        sizes: [],
  ...
  writeDataToFile("src/content/instance-free-tier-regions.json", instanceFreeTierRegions)
